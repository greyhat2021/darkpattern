...
function Resultpage() {
    ...
    const urgencyResult = result.urgency_info;

    return (
        <div>
            <br/><br/>
            <center><h1>DISCOVERED OMINOUS TRENDS</h1></center>
                ...
                <div className="result-cards-container">
                    {result && (
                        <>
                            ...
                            {urgencyResult && (
                                <div className="result-card timer-info-card">
                                    <h3>Urgency Information</h3>
                                    <p><strong>Status:</strong> {urgencyResult.status}</p>
                                    {urgencyResult.text_inside_div ? (
                                        <p className="urgency"><strong>Given Urgency Info:</strong> {urgencyResult.text_inside_div}</p>
                                    ) : (
                                        <p className="no-urgency">No urgency info found</p>
                                    )}
                                </div>
                            )}
                        </>
